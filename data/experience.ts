...
const data = [
  {
    ...
    body: {
      ...
      responsibilities: [
        "Spearheaded the development and launch of the IELTS Duck AI Speaking Mock Test website, building product prototype development, technology selection, and server architecture from the ground up.",
        ...
        "Employed a comprehensive technology stack comprising React, Node, Python/Flask and Serverless PostgreSQL to swiftly develop and validate the product’s market feasibility in the first stage.",
        ...
        "Initiated and planned the introduction of a mobile application to extend platform access, further improving user engagement and learning flexibility.",
        "Technical Stack: Go/Fiber, Python/Flask, React, Node, TypeScript, SCSS, PostgreSQL, Nginx, Amazon AWS, Redis",
      ],
    },
  },
  {
