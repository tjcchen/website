...
const data = [
  {
    ...
    body: {
      ...
      responsibilities: [
        "Spearheaded the development and launch of the IELTS Duck AI Speaking Mock Test website, orchestrating product prototype development, technology selection, and server architecture from the ground up.",
